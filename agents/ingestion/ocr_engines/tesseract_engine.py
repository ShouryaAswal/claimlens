...
----------------------------------------------------
The Tesseract-backed OCR engine. Sandbox/laptop-friendly default: pip + one
small apt package, no model download, no GPU. See paddleocr_engine.py for
the higher-accuracy, heavier alternative, and factory.py for how the two are
selected/auto-fallback between.
"""
